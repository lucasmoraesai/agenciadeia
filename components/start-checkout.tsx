...
export function StartCheckout() {
  ...
  return (
    <Container className="py-16 sm:py-24">
      ...
      {/* Proposta comercial — só visível na impressão (PDF) */}
      <div className="print-only">
        <div className="proposal-sheet mx-auto w-full max-w-2xl rounded-2xl bg-white p-8 text-neutral-900 sm:p-12">
          {/* Header */}
          ...
          <dl className="mt-8 grid grid-cols-2 gap-x-6 gap-y-4 text-sm sm:grid-cols-4">
            ...
            <div>
              ...
              <dd className="mt-1 font-medium">{company.trim() || "A definir"}</dd>
            </div>
            <div>
              <dt className="text-[10px] uppercase tracking-widest text-neutral-400">
                Emitido por
